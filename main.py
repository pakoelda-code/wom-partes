...
def admin_new_form(request: Request):
    ...
    sala_opts = "\n".join([f"<option value='{h(s)}'>{h(s)}</option>" for s in salas])
...
def admin_menu(request: Request):
    ...
    <div class="card">
      <div class="row">
        <a class="btn" href="/encargado/pendientes">Ver pendientes</a>
...
def admin_listar_usuarios(request: Request):
    ...
    <div class="card">
      <table>
        ...
        <tbody>{rows or "<tr><td colspan='3'>No hay usuarios.</td></tr>"}</tbody>
      </table>
